    ...
    void reserveSeat() {
      try {
        Map<String, String> Reservation = {
          // 'reservationId':
          //     widget.cinemaName! + widget.movieName! + widget.seatNumbers[i],
          'userId': FirebaseAuth.instance.currentUser!.uid.toString(),
          'cenima': widget.cinemaName,
          'movie': widget.movieName.toString(),
          'seats': widget.seatNumbers.toString(),
          'price': widget.totalPrice.toString(),
          'visa': widget.visaCardNumber.toString(),
        };
        dbRef!.push().set(Reservation);
      } catch (error) {
                                  ...
                                  Container(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        Container(
                                          // frame7621DH (12:3558)
                                          margin: EdgeInsets.fromLTRB(21 * fem,
                                              0 * fem, 21 * fem, 16 * fem),
